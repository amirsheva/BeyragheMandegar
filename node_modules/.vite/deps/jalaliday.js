...
// node_modules/jalaliday/dist/_chunks/plugin-CKyDwoA_.mjs
var import_fa = __toESM(require_fa(), 1);
...
var fa$1 = { jmonths: "فروردین_اردیبهشت_خرداد_تیر_مرداد_شهریور_مهر_آبان_آذر_دی_بهمن_اسفند".split("_") };
var plugin = (o, Dayjs, dayjs) => {
  ...
  proto.startOf = function(units, startOf) {
    ...
    switch (unit) {
      ...
      case M:
        return isStartOf ? instanceFactory(1, this.$jM) : instanceFactory(0, (this.$jM + 1) % 12, this.$jy + Math.floor((this.$jM + 1) / 12));
      case W:
...
//# sourceMappingURL=jalaliday.js.map
